...
public class EditTask {
    ...
    public static void EditingTask(ArrayList<String> Status,ArrayList<String> Title,ArrayList<String> Description, ArrayList<String> DueDate) {
